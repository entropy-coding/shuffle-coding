...
impl<
    ...
    RCosetCFromP: Fn(&C::Symbol) -> RCosetC + Clone,
    RCosetC: UniformCodec<Symbol=Permutation>>
Debug for PlainShuffleCodec<C, RCosetC, RCosetCFromP> {
...
impl<
    ...
    RCosetCFromP: Fn(&C::Symbol) -> RCosetC + Clone,
    RCosetC: UniformCodec<Symbol=Permutation>>
Eq for PlainShuffleCodec<C, RCosetC, RCosetCFromP> {}
...
/// Runs the given function with isomorphism tests for graphs above this length are disabled,
...
impl<P: PlainPermutable, Q: PlainPermutable> PlainPermutable for (P, Q) {
    fn automorphism_group(&self) -> PermutationGroup {
...
impl<P: PlainPermutable> PartialOrd<Self> for Unordered<P> {
    fn partial_cmp(&self, other: &Self) -> Option<std::cmp::Ordering> {
        self.to_ordered().canon().partial_cmp(&other.to_ordered().canon())
    }
}
...
pub mod test {
    ...
    pub fn test_plain_shuffle_codecs<C: Codec<Symbol: PlainPermutable> + Len>(
        codecs: &Vec<C>,
