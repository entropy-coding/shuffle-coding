...
/// By default, TU (https://chrsmrrs.github.io/datasets/docs/datasets/) and SZIP (https://github.com/entropy-coding/shuffle-coding/szip-graphs) datasets are available.
#[derive(Parser, Debug)]
